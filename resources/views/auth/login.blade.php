<x-guest-layout>
    <div class="mb-6">
        ...
        <p class="text-gray-600 text-sm mt-1">Login to your CareerNova account</p>
    </div>
    ...
    <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
        ...
        <ul class="text-sm text-blue-800 space-y-1">
            <li><strong>Admin:</strong> admin@careernova.com / admin123456</li>
            <li><strong>Teacher:</strong> teacher@test.com / password123</li>
